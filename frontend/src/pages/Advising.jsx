...
function Advising() {
    ...
    const fetchCurrentCourse = async () => {
        ...
        try {
            const response = await axios.get(
                "https://course-taking-9iv6.onrender.com/api/current-course",
                {
                    headers: {
                        Authorization: token,
                    },
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                const response = await axios.get(
                    "https://course-taking-9iv6.onrender.com/api/courses",
                    {
                        headers: {
                            Authorization: token,
                        },
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://course-taking-9iv6.onrender.com/api/submit-course",
                { selectedCourse },
                {
                    headers: {
                        Authorization: token,
    ...
    const handleDelete = async (e) => {
        ...
        try {
            const response = await axios.delete(
                "https://course-taking-9iv6.onrender.com/api/drop-course",
                {
                    headers: {
                        Authorization: token,
                    },
